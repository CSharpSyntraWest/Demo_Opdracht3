...
namespace Tweetbook.Sdk
{
    ...
    partial class AutoGeneratedITweetbookApi : ITweetbookApi
    {
        ...
        /// <inheritdoc />
        Task<ApiResponse<PagedResponse<PostResponse>>> ITweetbookApi.GetAllAsync()
        {
            var arguments = new object[] {  };
            var func = requestBuilder.BuildRestResultFuncForMethod("GetAllAsync", new Type[] {  });
            return (Task<ApiResponse<PagedResponse<PostResponse>>>)func(Client, arguments);
        }

        /// <inheritdoc />
        Task<ApiResponse<Response<PostResponse>>> ITweetbookApi.GetAsync(Guid postId)
        {
            var arguments = new object[] { postId };
            var func = requestBuilder.BuildRestResultFuncForMethod("GetAsync", new Type[] { typeof(Guid) });
            return (Task<ApiResponse<Response<PostResponse>>>)func(Client, arguments);
        }

        /// <inheritdoc />
        Task<ApiResponse<Response<PostResponse>>> ITweetbookApi.CreateAsync(CreatePostRequest createPostRequest)
        {
        ...
        /// <inheritdoc />
        Task<ApiResponse<Response<PostResponse>>> ITweetbookApi.UpdateAsync(Guid postId, UpdatePostRequest updatePostRequest)
        {
